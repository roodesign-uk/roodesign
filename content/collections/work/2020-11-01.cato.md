    ...
    content:
      ...
      -
        ...
        content:
          -
            type: text
            text: "For this project, I used user testing as an opportunity to experiment with a couple of enhancements to the Task List.\_"
      -
        type: paragraph
        content:
          -
        ...
        attrs:
          values:
            ...
            style:
              - shadow
            layout: full
            caption: 'Old versus new data entry page. We didn''t test the new version enough and this didn''t make it into production before the end of the project. I would have liked to spend more time here.'
    type: section
    enabled: true
  -
    title: Outcomes
